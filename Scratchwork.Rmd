...
seoul$Hour_chunks1 = cut(seoul$Hour, c(0,8,16,24), right = FALSE)



seoul_hourly_chunks_8hr <- seoul %>% 
  group_by(Date, Hour_chunks1, Min_T, Max_T, Min_H, Max_H,  Is_weekend, Season, Is_holiday) %>% summarise(
...
chunk_8hr = lmer(Bike_count ~ Hour_chunks1 + Min_T + Max_T + Min_H + Max_H + Wind_speed +
