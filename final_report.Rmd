...
To understand the bias and variance of our prediction results, we also drew the boxplots of predicted bike count and the true bike count of the four datasets. The plots are shown below. As we can see, DC has a very small range of both predicted and true bike counts, which explains why its RMSE and MAE values are much lower than that of the other data sets.
