...
Let $x_{ij}$ = (1,
I(HourChunk$_{ij}$ = [8:00,16:00)),
I(HourChunk$_{ij}$ = [16:00,24:00)),
Weekend$_{i}$,
Holiday$_{i}$,
I(Season$_{i}$ = Spring),
I(Season$_{i}$ = Summer),
...
In Equation (2), $b_i$ is the unobserved random effect that the day $i$ has on the number of rented bikes at any given hour chunk. It is assumed that $b_i \sim N(0,\sigma^2_\gamma)$. It is assumed that $b_k$ and $b_j$ are independent for any $k \neq j$.  
